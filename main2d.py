...
def run(cfg):
    ...
    # experiment_name = 'TRAIN:maxsteps_' + str(max_steps) + '-numpoints_' + str(num_points) + \
    #              '-timesteps_' + str(timesteps) + '-lr_' + str(learning_rate)

    # model_name = 'circle_env-max_steps_' + str(max_steps) + '-numpoints_' + str(num_points) + \
    #              '-timesteps_' + str(timesteps) + '-lr_' + str(learning_rate)

    experiment_name = "TRAIN-2Dmodeling-" + str(num_points) + 'points'
...
@hydra.main(config_path="confs", config_name="2dconfigs.yaml")
